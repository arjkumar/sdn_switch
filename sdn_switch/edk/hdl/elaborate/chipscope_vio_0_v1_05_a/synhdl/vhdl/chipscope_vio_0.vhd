...
entity chipscope_vio is
  generic (
    ...
    C_ASYNC_OUTPUT_ENABLE : integer := 0;
    C_SYNC_INPUT_ENABLE : integer := 0;
    C_SYNC_OUTPUT_ENABLE : integer := 1;

    C_ASYNC_INPUT_WIDTH : integer := 1;
    C_ASYNC_OUTPUT_WIDTH : integer := 8;
    C_SYNC_INPUT_WIDTH : integer := 8;
    C_SYNC_OUTPUT_WIDTH : integer := 1;
